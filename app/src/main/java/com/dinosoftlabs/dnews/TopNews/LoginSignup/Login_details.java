...
//            updateUI(false);
//            Variables.toast_msg(getContext()," Err " + result.getStatus());
//            Variables.alert_dialogue(getContext(),"Err","Err "+result.toString()+" \n Ststus "+result.getStatus());
//            Variables.Log_d_msg(getContext(),""+result.getStatus()+" "+result.toString());
        }
    }
    ...
    public void onConnectionFailed(@NonNull ConnectionResult connectionResult) {
        //Variables.toast_msg(getContext()," Err ");
    }
